      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php
         ...
         <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo "$data->jenis";?>">
            <div class="portfolio-img"><img src="gambar/<?php echo "$data->pamflet";?>" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4><?php echo "$data->nama";?></h4>
              <p><?php echo "$data->deskripsi";?></p>
              <a href="gambar/<?php echo "$data->pamflet";?>" data-gall="portfolioGallery" class="venobox preview-link" title="Konser 1"><i class="bx bx-plus"></i></a>
