...
<div id="mydaftarevent" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Email" required>
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Waktu</label>
      <input type="time" class="form-control" name="waktu" id="waktu" placeholder="Email" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="rupiah_tampil" placeholder="" readonly>
      <input type="number" class="form-control" name="harga" id="rupiah" placeholder="harga" required>
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Diskon</label>
      <?php echo cmb_dinamis('diskon','diskon','keterangan','id_diskon') ?>
    </div>
    <div class="form-group">
